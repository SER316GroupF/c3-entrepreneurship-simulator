...
public class CompanyPanel implements SimulationScreen
{
	...
	public CompanyPanel(Game game)
	{
		...
		upperSection.add(businessSelection)
				.spaceRight(0.1f * mainTable.getWidth()).center();
		upperSection.add(businessInfo).expand().fillX().left();
		lowerSection.add(businessGraph).expand().center();
		lowerSection.add(businessButtons).center()
				.width(0.2f * mainTable.getWidth());
	...
	private Actor createBusinessSelection()
	{
		...
		businessSelectionBox.setItems("No Business Selected", "Business 1",
	...
	/**
	 * This method gets the list of businesses from the data layer and displays
	...
	/**
	 * This method creates the GUI that will display the info for the selected
	 * business.
	 * 
	...
	/**
	 * This method should update the information section with the appropriate
	 * info for the selected business.
	 */
	...
	/**
	 * This method creates the buttons that give the option to rename or sell
	...
	/**
	 * This method creates the GUI component holding graph that represents the
	 * selected business.
	 * 
	 * @return The GUI component created.
	 */
