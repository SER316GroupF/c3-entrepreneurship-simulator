...
public class CouncilPanel
{
	...
	public CouncilPanel(Game game, Stage stage)
	{
		...
		navigationPanel.addSubButton("Company", "Business", AllManagementScreens.COMPANY_PANEL.getInstance());
		navigationPanel.addSubButton("Company", "Assets", null);
		navigationPanel.addButton("Tasks", null);
		navigationPanel.addSubButton("Tasks", "Manage", AllManagementScreens.TASK_MANAGEMENT.getInstance());
		navigationPanel.addSubButton("Tasks", "Completed", AllManagementScreens.COMPLETED_TASKS.getInstance());
