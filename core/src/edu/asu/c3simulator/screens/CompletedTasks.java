...
/**
 * This class displays a screen that shows a list of completed tasks divided
 * into two categories: Action Based and Non-Action Based.
 * 
...
public class CompletedTasks implements SimulationScreen
{
	...
	public CompletedTasks(Game game)
	{
		...
		TextButton nonActionBasedLabel = new TextButton("Non-Action Based",
				skin);
		...
		ScrollPane actionBasedTasksScroll = new ScrollPane(
				actionBasedTasksList, skin);
		ScrollPane nonActionBasedTasksScroll = new ScrollPane(
				nonActionBasedTasksList, skin);
	...
	/**
	 * This method creates a testing shell of different tasks to test and demo
	 * the GUI.
	 * 
	 * @return an ArrayList of the completed tasks that are going to be
	 *         displayed.
	 */
	private ArrayList<Task> getCompletedTasks()
	{
		String[] actionBasedList = { "task 1.1", "task 2.1", "task 3.1",
				"task 4.1", "task 5.1", "task 6.1", "task 7.1", "task 8.1",
				"task 9.1", "task 10.1", "task 11.1", "task 12.1", "task 13.1",
				"task 14.1", "task 15.1" };
		String[] nonActionBasedList = { "task 1.2", "task 2.2", "task 3.2",
				"task 4.2", "task 5.2", "task 6.2", "task 7.2", "task 8.2",
				"task 9.2", "task 10.2" };
